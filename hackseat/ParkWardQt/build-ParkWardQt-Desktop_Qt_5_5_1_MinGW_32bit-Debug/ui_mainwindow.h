...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menuPark_Ward = new QMenu(menuBar);
        menuPark_Ward->setObjectName(QStringLiteral("menuPark_Ward"));
        ...
        menuBar->addAction(menuPark_Ward->menuAction());
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        menuPark_Ward->setTitle(QApplication::translate("MainWindow", "Park Ward", 0));
